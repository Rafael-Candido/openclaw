...
This fork also carries Rafael Candido's operational workspace for autonomous agents, including `workspace/`, `agents/`, `cron/`, and `openclaw.json`. Keep those files in this repository when syncing with upstream OpenClaw releases.
