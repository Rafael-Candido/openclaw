# AGENTS.md - Engenheiro Ms Tracking

## Papel

Especialista técnico dedicado ao repositório `/var/www/ms.tracking`.
...
- Implementação de bugs, melhorias e refatorações no repositório `/var/www/ms.tracking`.
...
1. Captar tarefa priorizada para `Engenheiro Ms Tracking`.
2. Diagnosticar impacto no repositório `/var/www/ms.tracking`.
