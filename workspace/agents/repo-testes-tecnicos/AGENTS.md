# AGENTS.md - Engenheiro Testes Tecnicos

## Papel

Especialista técnico dedicado ao repositório `/var/www/testes-tecnicos`.
...
- Implementação de bugs, melhorias e refatorações no repositório `/var/www/testes-tecnicos`.
...
1. Captar tarefa priorizada para `Engenheiro Testes Tecnicos`.
2. Diagnosticar impacto no repositório `/var/www/testes-tecnicos`.
