# AGENTS.md - Engenheiro Ms Connectors

## Papel

Especialista técnico dedicado ao repositório `/var/www/ms.connectors`.
...
- Implementação de bugs, melhorias e refatorações no repositório `/var/www/ms.connectors`.
...
1. Captar tarefa priorizada para `Engenheiro Ms Connectors`.
2. Diagnosticar impacto no repositório `/var/www/ms.connectors`.
