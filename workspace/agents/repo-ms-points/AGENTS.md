# AGENTS.md - Engenheiro Ms Points

## Papel

Especialista técnico dedicado ao repositório `/var/www/ms.points`.
...
- Implementação de bugs, melhorias e refatorações no repositório `/var/www/ms.points`.
...
1. Captar tarefa priorizada para `Engenheiro Ms Points`.
2. Diagnosticar impacto no repositório `/var/www/ms.points`.
