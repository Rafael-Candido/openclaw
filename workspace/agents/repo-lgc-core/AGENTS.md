# AGENTS.md - Engenheiro Lgc Core

## Papel

Especialista técnico dedicado ao repositório `/var/www/lgc.core`.
...
- Implementação de bugs, melhorias e refatorações no repositório `/var/www/lgc.core`.
...
1. Captar tarefa priorizada para `Engenheiro Lgc Core`.
2. Diagnosticar impacto no repositório `/var/www/lgc.core`.
