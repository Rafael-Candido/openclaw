# AGENTS.md - Engenheiro App Drivers V2

## Papel

Especialista técnico dedicado ao repositório `/var/www/app-drivers-v2`.
...
- Implementação de bugs, melhorias e refatorações no repositório `/var/www/app-drivers-v2`.
...
1. Captar tarefa priorizada para `Engenheiro App Drivers V2`.
2. Diagnosticar impacto no repositório `/var/www/app-drivers-v2`.
