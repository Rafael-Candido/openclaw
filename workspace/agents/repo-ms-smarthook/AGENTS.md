# AGENTS.md - Engenheiro Ms Smarthook

## Papel

Especialista técnico dedicado ao repositório `/var/www/ms.smarthook`.
...
- Implementação de bugs, melhorias e refatorações no repositório `/var/www/ms.smarthook`.
...
1. Captar tarefa priorizada para `Engenheiro Ms Smarthook`.
2. Diagnosticar impacto no repositório `/var/www/ms.smarthook`.
