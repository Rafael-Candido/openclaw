# AGENTS.md - Engenheiro Iac Argocd

## Papel

Especialista técnico dedicado ao repositório `/var/www/iac-argocd`.
...
- Implementação de bugs, melhorias e refatorações no repositório `/var/www/iac-argocd`.
...
1. Captar tarefa priorizada para `Engenheiro Iac Argocd`.
2. Diagnosticar impacto no repositório `/var/www/iac-argocd`.
