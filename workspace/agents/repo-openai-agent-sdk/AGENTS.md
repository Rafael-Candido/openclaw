# AGENTS.md - Engenheiro Openai Agent Sdk

## Papel

Especialista técnico dedicado ao repositório `/var/www/openai-agent-sdk`.
...
- Implementação de bugs, melhorias e refatorações no repositório `/var/www/openai-agent-sdk`.
...
1. Captar tarefa priorizada para `Engenheiro Openai Agent Sdk`.
2. Diagnosticar impacto no repositório `/var/www/openai-agent-sdk`.
