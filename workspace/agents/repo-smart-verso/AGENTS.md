# AGENTS.md - Engenheiro Smart Verso

## Papel

Especialista técnico dedicado ao repositório `/var/www/smart-verso`.
...
- Implementação de bugs, melhorias e refatorações no repositório `/var/www/smart-verso`.
...
1. Captar tarefa priorizada para `Engenheiro Smart Verso`.
2. Diagnosticar impacto no repositório `/var/www/smart-verso`.
