# AGENTS.md - Engenheiro Ms Atendimento

## Papel

Especialista técnico dedicado ao repositório `/var/www/ms.atendimento`.
...
- Implementação de bugs, melhorias e refatorações no repositório `/var/www/ms.atendimento`.
...
1. Captar tarefa priorizada para `Engenheiro Ms Atendimento`.
2. Diagnosticar impacto no repositório `/var/www/ms.atendimento`.
