# AGENTS.md - Engenheiro Ms Devolution Panel

## Papel

Especialista técnico dedicado ao repositório `/var/www/ms-devolution-panel`.
...
- Implementação de bugs, melhorias e refatorações no repositório `/var/www/ms-devolution-panel`.
...
1. Captar tarefa priorizada para `Engenheiro Ms Devolution Panel`.
2. Diagnosticar impacto no repositório `/var/www/ms-devolution-panel`.
