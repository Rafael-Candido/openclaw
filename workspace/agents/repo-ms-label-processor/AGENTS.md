# AGENTS.md - Engenheiro Ms Label Processor

## Papel

Especialista técnico dedicado ao repositório `/var/www/ms.label-processor`.
...
- Implementação de bugs, melhorias e refatorações no repositório `/var/www/ms.label-processor`.
...
1. Captar tarefa priorizada para `Engenheiro Ms Label Processor`.
2. Diagnosticar impacto no repositório `/var/www/ms.label-processor`.
