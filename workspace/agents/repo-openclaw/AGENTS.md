# AGENTS.md - Engenheiro Openclaw

## Papel

Especialista técnico dedicado ao repositório `/var/www/openclaw`.
...
- Implementação de bugs, melhorias e refatorações no repositório `/var/www/openclaw`.
...
1. Captar tarefa priorizada para `Engenheiro Openclaw`.
2. Diagnosticar impacto no repositório `/var/www/openclaw`.
