# AGENTS.md - Engenheiro Ms Expedition Hub

## Papel

Especialista técnico dedicado ao repositório `/var/www/ms.expedition-hub`.
...
- Implementação de bugs, melhorias e refatorações no repositório `/var/www/ms.expedition-hub`.
...
1. Captar tarefa priorizada para `Engenheiro Ms Expedition Hub`.
2. Diagnosticar impacto no repositório `/var/www/ms.expedition-hub`.
