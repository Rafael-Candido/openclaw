# AGENTS.md - Engenheiro Uappi Wapi Freight

## Papel

Especialista técnico dedicado ao repositório `/var/www/uappi-wapi-freight`.
...
- Implementação de bugs, melhorias e refatorações no repositório `/var/www/uappi-wapi-freight`.
...
1. Captar tarefa priorizada para `Engenheiro Uappi Wapi Freight`.
2. Diagnosticar impacto no repositório `/var/www/uappi-wapi-freight`.
