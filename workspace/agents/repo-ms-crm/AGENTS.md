# AGENTS.md - Engenheiro Ms Crm

## Papel

Especialista técnico dedicado ao repositório `/var/www/ms.crm`.
...
- Implementação de bugs, melhorias e refatorações no repositório `/var/www/ms.crm`.
...
1. Captar tarefa priorizada para `Engenheiro Ms Crm`.
2. Diagnosticar impacto no repositório `/var/www/ms.crm`.
