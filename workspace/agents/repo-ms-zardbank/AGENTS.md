# AGENTS.md - Engenheiro Ms Zardbank

## Papel

Especialista técnico dedicado ao repositório `/var/www/ms.zardbank`.
...
- Implementação de bugs, melhorias e refatorações no repositório `/var/www/ms.zardbank`.
...
1. Captar tarefa priorizada para `Engenheiro Ms Zardbank`.
2. Diagnosticar impacto no repositório `/var/www/ms.zardbank`.
