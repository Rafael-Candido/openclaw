# AGENTS.md - Engenheiro Ms Customer Service

## Papel

Especialista técnico dedicado ao repositório `/var/www/ms.customer-service`.
...
- Implementação de bugs, melhorias e refatorações no repositório `/var/www/ms.customer-service`.
...
1. Captar tarefa priorizada para `Engenheiro Ms Customer Service`.
2. Diagnosticar impacto no repositório `/var/www/ms.customer-service`.
