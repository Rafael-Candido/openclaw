# AGENTS.md - Engenheiro Lc Point

## Papel

Especialista técnico dedicado ao repositório `/var/www/lc.point`.
...
- Implementação de bugs, melhorias e refatorações no repositório `/var/www/lc.point`.
...
1. Captar tarefa priorizada para `Engenheiro Lc Point`.
2. Diagnosticar impacto no repositório `/var/www/lc.point`.
