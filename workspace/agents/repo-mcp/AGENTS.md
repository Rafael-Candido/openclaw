# AGENTS.md - Engenheiro Mcp

## Papel

Especialista técnico dedicado ao repositório `/var/www/mcp`.
...
- Implementação de bugs, melhorias e refatorações no repositório `/var/www/mcp`.
...
1. Captar tarefa priorizada para `Engenheiro Mcp`.
2. Diagnosticar impacto no repositório `/var/www/mcp`.
